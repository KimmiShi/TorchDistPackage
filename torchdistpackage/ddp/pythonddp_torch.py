...
class PythonDDP(nn.Module):
    ...
    def __init__(self, module, process_group, async_reduction=True, buffer_size=2 ** 27):
        ...
        for name,param in self.module.named_parameters():
            if not param.requires_grad:
                print("do not require grad:", name, flush=True)
    ...
    def _on_param_grad_ready(self, param, grad):
        ...
        bucket.buffer[offset : offset + sz].copy_(grad.detach().contiguous().view(-1))
